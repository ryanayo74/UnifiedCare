...
class FacilityAdapter(private val facilities: List<Facility>, private val onItemClick: (Facility) -> Unit) :
    ...
    inner class FacilityViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(facility: Facility) {
            ...
            itemView.setOnClickListener {
                onItemClick(facility) // Call the listener with the clicked facility
            }
        }
    }
}
