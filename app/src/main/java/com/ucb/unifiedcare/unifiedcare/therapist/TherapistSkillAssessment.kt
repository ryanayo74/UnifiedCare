...
import com.ucb.unifiedcare.databinding.ActivityTherapistSkillAssessmentBinding
import java.text.SimpleDateFormat
import java.util.Calendar
import java.util.Locale

class TherapistSkillAssessment : AppCompatActivity() {
    private lateinit var binding: ActivityTherapistSkillAssessmentBinding
    private var currentWeekOffset = 0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTherapistSkillAssessmentBinding.inflate(layoutInflater)
